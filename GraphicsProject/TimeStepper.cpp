...
void RK4::takeStepAsteroid(AsteroidSystem* asteroidSystem, float stepSize)
{
    ...
    vector<Vector3f> s1 = asteroidSystem->getState();
    
    vector<Vector3f> k1 = asteroidSystem->evalF(s1);
    ...
    asteroidSystem->setState(nextState, s1);
